...
public class TemporaryMember {
    ...
    public TemporaryMember(String name, String slackId, String password, String slackNickName, String phoneNumber, Authority authority) {
        this.name = name;
    ...
    public Member toMember() {
        return new Member(this.name, this.slackId, this.password, this.slackNickName, this.phoneNumber, authority);
    }
